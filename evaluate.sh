...
python -u /scratch/eo41/minGPT/evaluate.py '/scratch/eo41/minGPT/saycam_labeled' --traindata_cache '/scratch/eo41/minGPT/data_model_cache/imagenet_trainset_64.pth' --model_cache '/scratch/eo41/minGPT/data_model_cache/model_24l_8h_512e_3b_SAY.pt' --probe_layer 18
